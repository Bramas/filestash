            ...
            <div className="component_submenu">
                <Container>
                    <div className={"menubar no-select "+(this.state.search_input_visible ? "search_focus" : "")}>
                        ...
                        <NgIf 
                            className="button-download-folder"
                            cond={this.props.accessRight.can_read !== false && this.props.selected.length === 0} 
                            type="inline" 
                            onMouseDown={this.onDownload.bind(this, [this.props.path])}>
                            <ReactCSSTransitionGroup transitionName="submenuwithSelection" transitionLeave={false} transitionEnter={false} transitionAppear={true} transitionAppearTimeout={10000}>
                                <span>
                                    { window.innerWidth < 410 && t("Download Folder").length > 10 ? t("Download Folder", null, "DOWNLOAD_FOLDER::SHORT") : t("Download Folder") }
                                </span>
                            </ReactCSSTransitionGroup>
                        </NgIf>
                        <NgIf
